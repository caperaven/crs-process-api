...
Deno.test("get_query_string - just query section", async () => {
    ...
    await crs.call("string", "get_query_string", {source: "remote=TenantIdentityProvider&action=UpdateTenantIdentityProvider&id=1662705947179108&parameters=tenantIdentity=contoso:test;crudResourceId=1662705947179108", target: "$context.result",}, context);
