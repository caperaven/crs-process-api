...
export async function initialize(root) {
    ...
    await crs.modules.add("data_processing", `${root}/action-systems/data-processing-actions.js`);
    ...
    await crs.modules.add("no_content", `${root}/action-systems/no-content-actions.js`);
    ...
    await crs.modules.add("route", `${root}/action-systems/route-actions.js`);
    ...
    await crs.modules.add("switch", `${root}/action-systems/switch-actions.js`);
    ...
    await crs.modules.add("dom_attributes", `${root}/action-systems/dom-attributes-actions.js`);
