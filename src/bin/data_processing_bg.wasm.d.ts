...
export function unique_values(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function get_perspective(a: number, b: number, c: number): void;
